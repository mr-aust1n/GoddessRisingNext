    ...
    <section className={styles.carouselContainer} aria-label="Hero Carousel">
      ...
      >
        <SwiperSlide className={`${styles.slide} ${styles.slide1}`}>
          {/* Slide 1 uses an actual image so we can prioritise loading */}
          <picture>
            <source
              media="(max-width: 767px)"
              srcSet="/assets/images/mobile/hair-extensions-goddess-rising-sm.webp"
            />
            <img
              src="/assets/images/hair-extensions-goddess-rising.webp"
